...
public class EnemySystem extends IteratingSystem {
	...
	protected void processEntity(Entity entity, float deltaTime) {
		...
		enemyCom.isGoingLeft = (distFromOrig > 5) != enemyCom.isGoingLeft;
		...
		Vector2 vec = bodyCom.body.getLinearVelocity();
		double angle = Math.atan2(vec.y, vec.x);
		bodyCom.body.setTransform(bodyCom.body.getPosition(), (float) angle);
